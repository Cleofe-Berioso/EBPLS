...
export function JitLayoutClient({
  ...
  return (
    <div className="app-shell bg-transparent text-slate-900">
      ...
      <JitSidebar mobileOpen={mobileOpen} collapsed={collapsed} onCloseMobile={() => setMobileOpen(false)} />
          ...
          <div className="flex min-h-[76px] items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-cyan-700">JIT Portal</p>
                <h1 className="truncate text-base font-semibold text-slate-900 sm:text-lg">Welcome, {userName}</h1>
                <p className="truncate text-sm text-slate-500">Dashboard and inspection queue interface shell</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="hidden min-w-0 text-right sm:block">
                ...
                <p className="truncate text-xs text-slate-500">JIT Portal</p>
              </div>
              <span className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-cyan-50 text-cyan-700 ring-1 ring-cyan-100">
