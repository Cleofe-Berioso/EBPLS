          ...
          <div className="flex min-h-[76px] items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-8">
            <div className="flex min-w-0 items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-emerald-700">Department Head Portal</p>
                <h1 className="truncate text-base font-semibold text-slate-900 sm:text-lg">Welcome, {userName}</h1>
                <p className="truncate text-sm text-slate-500">Approval and revocation decision workspace</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="hidden min-w-0 text-right sm:block">
                ...
                <p className="truncate text-xs text-slate-500">Department Head Portal</p>
              </div>
