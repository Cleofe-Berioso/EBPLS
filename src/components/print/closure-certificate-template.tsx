...
export function ClosureCertificateTemplate({ certificate }: ClosureCertificateTemplateProps) {
  ...
  return (
    <section className="mx-auto w-full max-w-[860px] bg-white px-3 py-4 text-black sm:px-4 print:max-w-none print:px-0 print:py-0">
      ...
      <article className="relative overflow-hidden rounded-[16px] border-[3px] border-pink-600 bg-white text-black print:rounded-none print:border-2">
        {/* Decorative top wave design */}
        <div className="absolute left-0 right-0 top-0 h-12 bg-gradient-to-r from-pink-600 via-pink-500 to-pink-600 opacity-90 print:opacity-100" />
        <svg
        ...
        <div className="relative z-10 px-4 py-6 sm:px-8">
          ...
          <header className="mb-8">
            <div className="grid grid-cols-[70px_1fr_70px] items-start gap-3 sm:grid-cols-[90px_1fr_90px]">
              ...
              <div className="flex justify-end">
                <div className="flex h-[70px] w-[70px] items-center justify-center rounded-full border-2 border-pink-600 bg-white p-1 sm:h-[90px] sm:w-[90px]">
                  <div className="text-center text-[10px] font-bold text-pink-600">BUSINESS<br/>PERMIT</div>
                </div>
              </div>
            </div>

            {/* Main title */}
            <div className="mt-6 border-b-4 border-pink-600 pb-3 text-center">
              <h1 className="text-[32px] font-black uppercase leading-tight tracking-wide text-pink-700 sm:text-[40px]">
            ...
            <div className="mt-2 text-center">
              <p className="text-[16px] font-bold uppercase text-pink-700">
          ...
          <section className="space-y-5 text-justify text-[14px] leading-relaxed sm:text-[15px]">
            ...
            <p>
              ...
              Closure Application through the Electronic Business Permit and Licensing System (eBPLS).
            </p>
          ...
          <section className="mt-10 flex justify-end">
            <div className="w-full max-w-[320px] text-center">
              ...
              <p className="font-bold">{certificate.signatories.bploOfficer || "[Authorized Approving Officer]"}</p>
              <p className="text-[13px] font-semibold uppercase">
                BPLO Head / Authorized Officer
              </p>
            </div>
          </section>

          {/* Footer */}
          <footer className="mt-8 space-y-1 border-t-2 border-pink-200 pt-4 text-center text-[12px] leading-snug">
            <p className="text-[13px] font-semibold">Generated by Electronic Business Permit and Licensing System (eBPLS)</p>
